...
class GetSavePolicyOgpoVtsPayloadStrategy(GetSavePolicyPayloadStrategyABC):
    product = 'ogpo-vts'
    ...
    def _get_structure(structures: List[Structure]) -> Dict:
        ...
        for structure in structures:
            if structure.type == 'driver':
                ...
                result_structure['vehicles'].append({'registration_number': structure.attrs.registration_number})
